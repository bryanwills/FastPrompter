...
This is the source of truth. Every key here MUST have a corresponding
entry in each language file. The translation registry validates against
this list on load.

Each entry: EN key → EN value (identity map for EN language).
"""
