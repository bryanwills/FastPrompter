...
TRANSLATIONS: dict[str, str] = {
    ...
    "Keep the window above all others":
        "Держать окно поверх всех остальных",
    ...
    "Snippet #{} already exists. Overwrite?":
        "Сниппет #{} уже существует. Перезаписать?",
    ...
    "Cycle Snap Corners (move across screens)":
        "Перемещение по углам (между экранами)",
    "Database backed up to:\n{}": "База сохранена в:\n{}",
    "Delete from this silo's folder?\n\n{}\n":
        "Удалить из папки этого сила?\n\n{}\n",
    "Delete…\tDel": "Удалить…\tDel",
    ...
    "Remove all custom fonts from the font selector?":
        "Удалить все пользовательские шрифты из списка?",
    ...
    "Editor Link": "Ссылка в редакторе",
    ...
    "Rows:": "Строки:",
    "Columns:": "Столбцы:",
    "Unpin this silo": "Открепить это сило",
    "Pin this silo to top": "Закрепить это сило сверху",
}
